    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                const float xPos = i.uv.x;
                const float yPos = i.uv.y;

                const bool display =
                    xPos > minXValToDisplay &&
                    xPos < maxXValToDisplay &&
                    yPos > minYValToDisplay &&
                    yPos < maxYValToDisplay;
                
                return display ? _Color : 0;
            }
            ENDCG
        }
    }
